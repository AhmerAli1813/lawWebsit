                    ...
                    <nav class="law-nav" role="navigation">
                        <div class="top-menu">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xs-2">
                                        <div id="law-logo"><a href="index.php">Law<span>.</span></a></div>
                                    </div>
                                    <div class="col-xs-10 text-right menu-1">
                                        <ul>
                                            <li class="active"><a href="index.php">Home</a></li>
                                            <li><a href="practice.php">Practice Areas</a></li>
                                            <li><a href="AllCase.php"> Cases</a></li>
                                          
                                            <li><a href="about.php">About</a></li>
                                            <li><a href="contact.php">Contact</a></li>';
                                            if(isset($_SESSION['unique_id'])){
                                               echo ' <li><a href="about.php">'.$_SESSION['Name'].'</a></li>
...
function case_select_input(){
 ...
 function lawyers(){
        ...
        $q=$db_conn->query("SELECT * FROM `lawyers` limit 0,3");
        if(mysqli_num_rows($q) >0){
            while($row =mysqli_fetch_assoc($q)){
