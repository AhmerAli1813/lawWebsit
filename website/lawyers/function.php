...
include '../includes/config.php';
    if(isset($_SESSION["role_id"])){
      $u_ids = $_SESSION["unique_id"];
        if($_SESSION["role_id"]!="2"){
          header("Location:../login.php ");          
        }else{
                $q=$db_conn->query("SELECT lawyer_id FROM `job_request` WHERE `lawyer_id` = '$u_ids' AND status = 'approved'");
                if($q){
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <a href="../profile.php" class="dropdown-item">
                                                            <!-- Message Start -->
                                                            <div class="media">
                                                            <img src="../dist/img/'.$userImg.'" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                                                    ...
                                                    <li> 
                                                            <div class="user-panel d-flex">
                                                                ...
                                                                <div class="info">
                                                                <a href="../logout.php?" class="ml-2 btn btn-dark btn-xs d-block text-capitalize"><i class="fas fa-sign-out-alt"></i></a>
                                                                </div>
...
function footers()
{
    echo '
                ...
                <div class="float-right d-none d-sm-block">
                    <b>Aptech SFC</b> 3.2.0
                </div>
                <strong>Copyright &copy; 2022-2023 <a href="#">Aptech E-project</a>.</strong> All rights reserved.
                </footer>
                <!-- Control Sidebar -->
