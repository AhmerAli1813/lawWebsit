...
if(mysqli_num_rows($q) >0){
        while($row = mysqli_fetch_assoc($q)){
                ...
                <td class='d-flex'><a href='action/action.php?del_id={$row['app_id']}' class='btn btn-danger' '><i class='fas fa-drum'></i></a><a href='cases.php?edit={$row['app_id']}' id='edit_btn'   class='ml-1 btn btn-info'><i class='fas fa-book-open'></i></a></td>
                </tr>                
                ";
        }
}else{
